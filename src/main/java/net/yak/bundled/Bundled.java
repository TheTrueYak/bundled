...
public class Bundled implements ModInitializer {
	...
	public static final TagKey<Item> HALF_WEIGHT = TagKey.of(Registries.ITEM.getKey(), id("half_weight"));
	public static final TagKey<Item> QUARTER_WEIGHT = TagKey.of(Registries.ITEM.getKey(), id("quarter_weight"));
	public static final TagKey<Item> EIGHTH_WEIGHT = TagKey.of(Registries.ITEM.getKey(), id("eighth_weight"));
	public static final TagKey<Item> SIXTEENTH_WEIGHT = TagKey.of(Registries.ITEM.getKey(), id("sixteenth_weight"));
	public static final TagKey<Item> THIRTYSECOND_WEIGHT = TagKey.of(Registries.ITEM.getKey(), id("thirtysecond_weight"));
	public static final TagKey<Item> SIXTYFOURTH_WEIGHT = TagKey.of(Registries.ITEM.getKey(), id("sixtyfourth_weight"));
